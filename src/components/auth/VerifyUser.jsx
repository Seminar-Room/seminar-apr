...
export default function VerifyUser(){
    ...
    const verifyUserEmail = async (emailId) => {
        ...
        var response = await fetch("https://seminarroom.in/api/api/verify-user", {
            method: "POST",
    ...
    const login = async (emailId, password) => {
        ...
        var response = await fetch("https://seminarroom.in/api/api/login", {
            method: "POST",
    ...
    const getColleges = async() => {
        var response = await fetch("https://seminarroom.in/api/api/get-colleges",{
            method: "POST",
            headers: {
                "Content-Type": "application/json",
              },
